...
func (*DBCallRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_postgres_28bc4696054a974a, []int{0}
}
...
func (*DBCallResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_postgres_28bc4696054a974a, []int{1}
}
...
func init() {
	proto.RegisterType((*DBCallRequest)(nil), "orbit.DBCallRequest")
	proto.RegisterType((*DBCallResponse)(nil), "orbit.DBCallResponse")
}
...
func (c *postGresClient) DBCall(ctx context.Context, in *DBCallRequest, opts ...grpc.CallOption) (*DBCallResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orbit.PostGres/DBCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterPostGresServer(s *grpc.Server, srv PostGresServer) {
...
func _PostGres_DBCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orbit.PostGres/DBCall",
	}
...
func init() { proto.RegisterFile("postgres.proto", fileDescriptor_postgres_28bc4696054a974a) }

var fileDescriptor_postgres_28bc4696054a974a = []byte{
	// 141 bytes of a gzipped FileDescriptorProto
	,
}
